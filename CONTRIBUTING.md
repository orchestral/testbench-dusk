...
When you make a pull request, the tests will automatically be run again by [GitHub Actions](https://github.com/orchestral/testbench-dusk/actions) on multiple php versions.
